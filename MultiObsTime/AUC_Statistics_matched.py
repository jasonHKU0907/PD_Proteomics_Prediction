...
#outfile = dpath + 'MultiObsTime/ProPANEL_matched.csv'
outfile = dpath + 'MultiObsTime/FULL_matched.csv'

out_lst = []
for yr in [2, 4, 6, 8, 10, 12, 14, 100]:
    #mydf = pd.read_csv(dpath + 'Matched/FULL/ProPanel_PredProbs.csv')
    mydf = pd.read_csv(dpath + 'Matched/FULL/FULL_PredProbs.csv')
