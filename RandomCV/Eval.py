...
mydf = pd.read_csv(dpath + 'Neurology_Revision/Results/RandomCV/ProPanelPrediction.csv')
outfile = dpath + 'Neurology_Revision/Results/RandomCV/ProPanelEvaluation.csv'

fold_id_lst = [i for i in range(10)]

opt_ct = Find_Optimal_Cutoff(mydf.target_y, mydf.y_pred_probs)[0]
result_df = get_avg_output(mydf, 'target_y', 'y_pred_probs', 'Fold_code', fold_id_lst, opt_ct)
