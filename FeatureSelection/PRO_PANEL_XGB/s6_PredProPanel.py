...
outpath = dpath + 'Neurology_Revision/Results/ProPanelSelection/XGB_ProPANEL/'
outfile = outpath + 's6_ProPANEL_PredProbs_XGB.csv'

pro_f_df = pd.read_csv(outpath + 's5_AccAUC_TotalGain.csv')
nb_pro_f = get_top_pros(pro_f_df)
my_f_lst = pro_f_df.Pro_code.tolist()[:nb_pro_f]
