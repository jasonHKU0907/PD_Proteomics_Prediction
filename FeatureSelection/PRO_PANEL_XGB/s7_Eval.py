...
mydf = pd.read_csv(dpath + 'Neurology_Revision/Results/ProPanelSelection/XGB_ProPANEL/s6_ProPANEL_PredProbs_XGB.csv')
outfile = dpath + 'Neurology_Revision/Results/ProPanelSelection/XGB_ProPANEL/s7_ProPANEL_Eval_XGB.csv'
