...
mydf = pd.read_csv(dpath + 'Neurology_Revision/Results/ProPanelSelection/XGB_PDRP/s4_PDRP_PredProbs_XGB.csv')
outfile = dpath + 'Neurology_Revision/Results/ProPanelSelection/XGB_PDRP/s5_PDRP_Eval_XGB.csv'
