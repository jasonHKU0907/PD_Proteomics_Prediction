...
outpath = '/Volumes/JasonWork/Projects/PD_Proteomics/Neurology_Revision/Results/ProPanelSelection/XGB_PDRP/'
outfile = outpath + 's3_SFS.csv'

imp_f_df = pd.read_csv(outpath + 's2_FeaImportance.csv')
imp_f_df.sort_values(by='TotalGain_cv', ascending=False, inplace=True)
imp_f_lst = imp_f_df.Pro_code.tolist()[:50]
