...
outpath = '/Volumes/JasonWork/Projects/PD_Proteomics/Neurology_Revision/Results/ProPanelSelection/'
outfile = outpath + 'XGB_PDRP/s2_FeaImportance1.csv'

pro_f_df = pd.read_csv(outpath + 'XGB_ProPANEL/s5_AccAUC_TotalGain.csv')
...
cov_f_lst = ['DM_AGE', 'DM_GENDER', 'DM_ETH', 'DM_TDI', 'DM_EDUC',
             ...
             'PS_RBD', 'PS_UI', 'PS_ED', 'PS_CSP', 'PS_ANX', 'PS_OH', 'PS_HYM',
...
for fold_id in fold_id_lst:
    ...
    X_train, X_test = mydf.iloc[train_idx][pro_f_lst+cov_f_lst], mydf.iloc[test_idx][pro_f_lst+cov_f_lst]
