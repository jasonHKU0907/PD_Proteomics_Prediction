...
outpath = '/Volumes/JasonWork/Projects/PD_Proteomics/Data/TargetOutcomes/PSM/'
...
target_date_f = ['42030-0.0', '42032-0.0', '42034-0.0', '42036-0.0']
target_source_f = ['42031-0.0', '42033-0.0', '42035-0.0', '42037-0.0']

target_f = ['eid'] + target_date_f + target_source_f
target_df = pd.read_csv(dpath + 'ukb672277.csv', usecols=target_f)
...
target_df_out.to_csv(outpath + 'PSM_ALG.csv', index = False)
