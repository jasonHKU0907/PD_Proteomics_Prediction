...
outpath = '/Volumes/JasonWork/Projects/PD_Proteomics/Data/TargetOutcomes/PD/'
...
target_date_f = ['42032-0.0']
target_source_f = ['42033-0.0']
...
target_df_out.to_csv(outpath + 'PD_ALG.csv', index = False)
