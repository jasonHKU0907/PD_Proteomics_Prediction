...
mydf = pd.read_csv(dpath + 'UKB_ALL/OVER10YEARS/ProPANEL_PredProbs_Retrained.csv')
outfile = dpath + 'UKB_ALL/OVER10YEARS/ProPANEL_STAT_Retrained.csv'

mydf = pd.read_csv(dpath + 'UKB_ALL/OVER10YEARS/FULL_PredProbs_Retrained.csv')
outfile = dpath + 'UKB_ALL/OVER10YEARS/FULL_STAT_Retrained.csv'
