...
outfile = dpath + 'UKB_ALL/PRO_PANEL/s7_Statistics.csv'
...
my_auc = []
for fold_id in fold_id_lst:
    tmp_idx = mydf['Region_code'].index[mydf['Region_code'] == fold_id]
    tmpdf = mydf.iloc[tmp_idx]
    my_auc.append(roc_auc_score(tmpdf.target_y, tmpdf.NEFL))
