...
outfile = outpath + 'UKB_ALL/PRO_PANEL/s3_rmMultiColinearity.csv'
outimg = outpath + 'UKB_ALL/PRO_PANEL/s3_rmMultiColinearity1.png'
Imp_df = pd.read_csv(outpath + 'UKB_ALL/PRO_PANEL/s2_PROImportance.csv')
...
fig, (ax2, ax1) = plt.subplots(2, 1, figsize=(7, 16))
dendro = hierarchy.dendrogram(dist_linkage, labels=pro_f_lst, ax=ax2)
ax2.set_xticklabels(dendro["ivl"], fontsize=10, horizontalalignment='right')
...
ax1.set_xticklabels(dendro["ivl"], rotation=90, fontsize=10, horizontalalignment='right')
