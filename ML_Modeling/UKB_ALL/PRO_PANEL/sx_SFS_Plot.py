...
output_img_dir = dpath + 'UKB_ALL/PRO_PANEL//AccAUC_TotalGain.png'
pro_imp_df = pd.read_csv(dpath + 'UKB_ALL/PRO_PANEL/PROImportance.csv')
pro_imp_df.rename(columns = {'TotalGain_cv': 'Pro_imp'}, inplace = True)
pro_auc_df = pd.read_csv(dpath + 'UKB_ALL/PRO_PANEL/AccAUC_TotalGain.csv')
