...
dpath = '/Volumes/JasonWork/Projects/PD_Proteomics/Revision_R2/'

mydf = pd.read_csv(dpath + 'Results/Matched/ProPanel_Retrained_OldFeat_PredProbs.csv')
outfile = dpath + 'Results/Matched/ProPanel_Retrained_OldFeat_Stat.csv'
opt_ct = 0.5

mydf = pd.read_csv(dpath + 'Results/UKB_ALL/PRO_PANEL/s6_ProPANEL_PredProbs.csv')
outfile = dpath + 'Results/Matched/ProPanel_Original_Stat.csv'
opt_ct = 0.013

mydf = pd.read_csv(dpath + 'Results/Matched/PDRP_Retrained_OldFeat_PredProbs.csv')
outfile = dpath + 'Results/Matched/PDRP_Retrained_OldFeat_Stat.csv'
opt_ct = 0.5

mydf = pd.read_csv(dpath + 'Results/UKB_ALL/FULL/s3_PDRP_PredProbs.csv')
outfile = dpath + 'Results/Matched/PDRP_Original_Stat.csv'
opt_ct = 0.018

match_df = pd.read_csv(dpath + 'Data/matchit_nearest_data_one_to_one.csv')
mydf = pd.merge(match_df, mydf, how = 'left', on = ['eid'])
