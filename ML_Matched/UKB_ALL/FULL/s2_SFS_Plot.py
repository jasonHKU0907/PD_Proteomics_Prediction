...
output_img_dir = dpath + 'UKB_ALL_Matched/FULL/SFS_plot.png'

pro_imp_df = pd.read_csv(dpath + 'UKB_ALL_Matched/FULL/FeaImportance.csv')
pro_imp_df.rename(columns = {'TotalGain_cv': 'Pro_imp'}, inplace = True)
pro_auc_df = pd.read_csv(dpath + 'UKB_ALL_Matched/FULL/AccAUC_TotalGain.csv')
